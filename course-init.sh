...
execute_init()
{
	...
	sed -i "s/basic_deployment_aap2.5/${REPONAME}/g" *.* > /dev/null 2>&1
	sed -i "s/basic_deployment_aap2.5/${REPONAME}/g" supplemental-ui/partials/header-content.hbs > /dev/null 2>&1
	echo -e "done"
