...
. You can access the AAP web interface using the *admin* user and the *password* copied from the secret in step 15. and use the link given in the RHDP login page: *After AAP Installation* to access the AAP web interface. 
